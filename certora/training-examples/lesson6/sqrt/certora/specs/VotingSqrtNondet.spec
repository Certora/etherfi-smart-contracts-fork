/* Spec for Square Root Voting Strength - `NONDET` summary */
...
methods
{
    ...
    // Using `nondet` summary - which is sound for view functions
    function sqrt(uint256) internal returns (uint256) => NONDET;
