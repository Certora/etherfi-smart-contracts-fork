/* Spec for Square Root Voting Strength - ALWAYS summary */
...
methods
{
    ...
    // Using always summary - the value matters in this case
    // Note: summarizing the internal function!
    function sqrt(uint256) internal returns (uint256) => ALWAYS(50);
